---
title: Adobe GenStudio per revisioni e approvazioni di Performance Marketers
...
# Adobe GenStudio per revisioni e approvazioni di Performance Marketers

Il flusso di lavoro di revisione e approvazione di GenStudio for Performance Marketers garantisce che tutte le parti interessate, dai team creativi agli esperti legali, possano rivedere e approvare in modo efficiente i componenti della campagna, incluse le risorse del marchio generate dall’intelligenza artificiale.

## Vantaggi del flusso di lavoro [!DNL Review and Approval]

* **Supporto per la creazione di contenuti di IA generativa e affidabile**. La creazione e l’implementazione di contenuti allineati al brand in un’organizzazione è un processo altamente iterativo. Le funzionalità di intelligenza artificiale generative di GenStudio for Performance Marketers supportano la creazione rapida di centinaia di varianti di risorse. Ogni revisore può richiedere più modifiche a una bozza di risorsa prima di approvarla. Maggiore è il numero di revisori potenziali prima che tutte le parti interessate concordino su una variante finale.
...
Quando una bozza completa il processo di revisione e approvazione e viene pubblicata in [!DNL Content], l&#39;ID bozza scade e GenStudio for Performance Marketers non salva i commenti e gli stati di approvazione associati. L’URL della bozza non è più valido.
...
Le notifiche interne al prodotto di GenStudio for Performance Marketers aggiornano in tempo reale gli approvatori e i creatori di contenuti in merito alle modifiche dello stato delle risorse e ai commenti di revisione. Le notifiche supportano una rapida iterazione attraverso più cicli di revisione, modifica e approvazione.
